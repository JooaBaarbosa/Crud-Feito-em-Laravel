    ...
    <div class="container">
        <form  action="{{ route('update', ['slide' => $slide->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="titulo" name="titulo" value="{{ $slide->titulo }}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="categoria" name="categoria"  value="{{ $slide->categoria }}">
            ...
            <div class="form-group">
                ...
                @endif
                <br/>
                <img src="{{ asset('/uploads/slide/' . $slide->imagem) }}" class="img-fuild img-thumbnail">
            </div>
